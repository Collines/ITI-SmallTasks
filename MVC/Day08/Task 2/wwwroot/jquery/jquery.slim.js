...
var i,
	...
	booleans = "checked|selected||autofocus|autoplay|controls|defer|disabled|hidden|" +
...
// Support: IE <=9 - 11+
// focus() and blur() are hronous, except when they are no-op.
	...
	jQuery.event.add( el, type, {
		...
		handler: function( event ) {
			...
			if ( ( event.isTrigger & 1 ) && this[ type ] ) {
				...
				// from an  native handler (gh-4350)
				if ( !saved.length ) {
					...
					// Support: IE <=9 - 11+
					// focus() and blur() are hronous
					not = expectSync( this, type );
					this[ type ]();
